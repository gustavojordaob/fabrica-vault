# RAG Eval — Hot path (RRF, sem rerank)

Gerado em: 2026-06-28T22:31:17.614271+00:00
...
|------|---|-------|-------|-------|-----|
| fabrica | 6 | 50.0% | 100.0% | 100.0% | 0.7500 |
| fluxo | 4 | 50.0% | 75.0% | 75.0% | 0.6250 |
| integracao | 4 | 50.0% | 100.0% | 100.0% | 0.7083 |
...
- **Top-5:** `lashmatch-mercadopago-assinatura.md`, `erros-e-solucoes.md`, `excluir-conta-app-expo-padrao.md`, `whatsapp-salao-expo-padrao.md`, `whatsapp-salao-expo-padrao.md`
...
- **Top-5:** `padroes-fabrica.md`, `firebase-setup-patterns.md`, `whatsapp-salao-expo-padrao.md`, `cloud-functions-patterns.md`, `excluir-conta-app-expo-padrao.md`
...
- **Top-5:** `auth-patterns.md`, `auth-patterns.md`, `erros-e-solucoes.md`, `mercadopago-assinatura-ota-padroes.md`, `cortejo-web-desktop.md`
...
- **Top-5:** `whatsapp-business-api.md`, `whatsapp-business-api.md`, `whatsapp-business-api.md`, `whatsapp-salao-expo-padrao.md`, `decisoes.md`
...
- **Top-5:** `whatsapp-salao-expo-padrao.md`, `whatsapp-salao-expo-padrao.md`, `decisoes.md`, `whatsapp-salao-expo-padrao.md`, `whatsapp-salao-expo-padrao.md`
...
- **Top-5:** `outros.md`, `mercadopago-integration.md`, `mercadopago-integration.md`, `cortejo-prd.md`, `outros.md`
...
- **Top-5:** `lashmatch-web-plataforma.md`, `expo-router-navegacao.md`, `expo-router-navegacao.md`, `lashmatch-web-plataforma.md`, `cortejo-modulos-jun2026-padrao.md`

### gs-016 — rank 1

- **Query:** gate bloqueia write até chamar rag_buscar
- **Esperado:** `arquitetura-fabrica-ia.md` (fabrica)
- **Top-5:** `arquitetura-fabrica-ia.md`, `arquitetura-fabrica-ia.md`, `arquitetura-fabrica-ia.md`, `arquitetura-fabrica-ia.md`, `arquitetura-fabrica-ia.md`
...
- **Esperado:** `arquitetura-fabrica-ia.md` (fabrica)
- **Top-5:** `arquitetura-fabrica-ia.md`, `arquitetura-fabrica-ia.md`, `arquitetura-fabrica-ia.md`, `erros-e-solucoes.md`, `arquitetura-fabrica-ia.md`

### gs-019 — rank 2

- **Query:** servidor rag fecha depois de carregar modelo chroma
- **Esperado:** `erros-e-solucoes.md` (solucao)
- **Top-5:** `arquitetura-fabrica-ia.md`, `erros-e-solucoes.md`, `arquitetura-fabrica-ia.md`, `arquitetura-fabrica-ia.md`, `erros-e-solucoes.md`

### gs-020 — rank 2

- **Query:** mercado pago ou revenuecat qual mcp usar?
- **Esperado:** `mcps-cursor-padrao.md` (fabrica)
- **Top-5:** `mercadopago-integration.md`, `mcps-cursor-padrao.md`, `decisoes.md`, `lashmatch-revenuecat-assinatura.md`, `cortejo-modulos-jun2026-padrao.md`

### gs-021 — rank 1

- **Query:** agente codou calendário sem buscar no rag
- **Esperado:** `erros-e-solucoes.md` (solucao)
- **Top-5:** `erros-e-solucoes.md`, `rag-protocolo-antes-de-codar.md`, `outros.md`, `decisoes.md`, `arquitetura-fabrica-ia.md`

### gs-022 — rank 1

- **Query:** fluxo criar feature branch e abrir pr na fabrica
- **Esperado:** `arquitetura-fabrica-ia.md` (fluxo)
- **Top-5:** `arquitetura-fabrica-ia.md`, `arquitetura-fabrica-ia.md`, `arquitetura-fabrica-ia.md`, `arquitetura-fabrica-ia.md`, `context-api-estado.md`
...
- **Esperado:** `arquitetura-fabrica-ia.md` (fabrica)
- **Top-5:** `firebase-deploy-checklist-padrao.md`, `arquitetura-fabrica-ia.md`, `expo-router-navegacao.md`, `firebase-setup-patterns.md`, `checklists-deploy.md`
