...
Gerado em: 2026-06-28T14:12:04.905830+00:00
...
|------|---|-------|-------|-------|-----|
| fabrica | 6 | 33.3% | 33.3% | 66.7% | 0.4167 |
| fluxo | 4 | 25.0% | 50.0% | 50.0% | 0.3750 |
| integracao | 4 | 25.0% | 75.0% | 100.0% | 0.5625 |
| padrao | 5 | 40.0% | 40.0% | 40.0% | 0.4000 |
...
### gs-002 — MISS ⚠️ revisar

- **Query:** qual path artifacts appId users uid no firestore?
- **Esperado:** `lashmatch-schemas.md` (padrao)
- **Top-5:** `padroes-fabrica.md`, `firebase-setup-patterns.md`, `lashmatch-prd.md`, `whatsapp-salao-expo-padrao.md`, `checklists-deploy.md`
...
### gs-011 — rank 4 ⚠️ revisar

- **Query:** webhook mercado pago confirma pagamento cloud function
- **Esperado:** `mercadopago-integration.md` (integracao)
- **Top-5:** `outros.md`, `cortejo-prd.md`, `lashmatch-prd.md`, `mercadopago-integration.md`, `mercadopago-integration.md`
...
- **Top-5:** `checklists-deploy.md`, `cloud-functions-patterns.md`, `cloud-functions-patterns.md`, `firebase-setup-patterns.md`, `cloud-functions-patterns.md`

### gs-014 — MISS ⚠️ revisar

- **Query:** checklist antes de rodar firebase deploy
- **Esperado:** `checklists-deploy.md` (fluxo)
- **Top-5:** `arquitetura-fabrica-ia.md`, `mcps-cursor-padrao.md`, `agenda-salao-expo-padrao.md`, `outros.md`, `firebase-setup-patterns.md`

### gs-015 — MISS

- **Query:** expo export web e deploy firebase hosting
- **Esperado:** `firebase-setup-patterns.md` (fluxo)
- **Top-5:** `expo-router-navegacao.md`, `lashmatch-web-plataforma.md`, `cortejo-modulos-jun2026-padrao.md`, `lashmatch-web-plataforma.md`, `expo-router-navegacao.md`

### gs-016 — rank 1

- **Query:** gate bloqueia write até chamar rag_buscar
- **Esperado:** `arquitetura-fabrica-ia.md` (fabrica)
- **Top-5:** `arquitetura-fabrica-ia.md`, `erros-e-solucoes.md`, `decisoes.md`, `lashmatch-prd.md`, `outros.md`

### gs-017 — MISS

- **Query:** dev pediu lib externa devo consultar rag antes?
- **Esperado:** `rag-protocolo-antes-de-codar.md` (fabrica)
- **Top-5:** `decisoes.md`, `decisoes.md`, `erros-e-solucoes.md`, `lashmatch-revenuecat-assinatura.md`, `decisoes.md`

### gs-018 — rank 4

- **Query:** como subir servidor chroma rag porta 7332?
- **Esperado:** `arquitetura-fabrica-ia.md` (fabrica)
- **Top-5:** `whatsapp-salao-expo-padrao.md`, `erros-e-solucoes.md`, `auth-patterns.md`, `arquitetura-fabrica-ia.md`, `auth-patterns.md`

### gs-019 — rank 1 ⚠️ revisar

- **Query:** servidor rag fecha depois de carregar modelo chroma
- **Esperado:** `erros-e-solucoes.md` (solucao)
- **Top-5:** `erros-e-solucoes.md`, `arquitetura-fabrica-ia.md`, `spring-backend.md`, `erros-e-solucoes.md`, `decisoes.md`
...
- **Esperado:** `erros-e-solucoes.md` (solucao)
- **Top-5:** `erros-e-solucoes.md`, `cloud-functions-patterns.md`, `whatsapp-business-api.md`, `outros.md`, `rag-protocolo-antes-de-codar.md`

### gs-022 — rank 1

- **Query:** fluxo criar feature branch e abrir pr na fabrica
- **Esperado:** `arquitetura-fabrica-ia.md` (fluxo)
- **Top-5:** `arquitetura-fabrica-ia.md`, `arquitetura-fabrica-ia.md`, `firestore-schemas.md`, `arquitetura-fabrica-ia.md`, `context-api-estado.md`
...
- **Esperado:** `arquitetura-fabrica-ia.md` (fabrica)
- **Top-5:** `arquitetura-fabrica-ia.md`, `erros-e-solucoes.md`, `decisoes.md`, `padroes-fabrica.md`, `decisoes.md`

### gs-025 — rank 4

- **Query:** deploy firebase no projeto errado como evitar
- **Esperado:** `arquitetura-fabrica-ia.md` (fabrica)
- **Top-5:** `checklists-deploy.md`, `erros-e-solucoes.md`, `firebase-setup-patterns.md`, `arquitetura-fabrica-ia.md`, `agenda-salao-expo-padrao.md`
